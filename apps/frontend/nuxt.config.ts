...
export default defineNuxtConfig({
	...
	pwa: {
		...
		manifest: {
			...
			categories: ['discord', 'bot', 'skyra', 'game', 'fun', 'rpg', 'epic', 'kyra', 'favna', 'kyranet'],
	...
	app: {
		head: {
			...
			meta: [
				...
				{ name: 'subject', content: "Skyra Project's RPG Game" },
				{ name: 'summary', content: "Skyra Project's RPG Game." },
				...
				{ property: 'og:description', content: "Skyra Project's RPG Game" },
				...
				{ property: 'og:site_name', content: "Skyra Project's RPG Game" },
				{ property: 'og:title', content: "Skyra Project's RPG Game" },
